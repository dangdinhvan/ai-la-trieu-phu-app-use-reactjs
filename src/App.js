...
const DATA = [
	...
	},
	{
		id: '6',
		question:
			'Tính đến tháng 8/2021 ai là cầu thủ sở hữu nhiều danh hiệu Quả bóng vàng nhất?',
...
function App() {
	...
	const help5050 = () => {
		...
		if (help5050State === true) {
			let arrIncorrect = [];
			if (
				DATA[questionCount].answerA !==
				DATA[questionCount].answerCorrect
			) {
				arrIncorrect.push(DATA[questionCount].answerA);
			}
			if (
				DATA[questionCount].answerB !==
				DATA[questionCount].answerCorrect
			) {
				arrIncorrect.push(DATA[questionCount].answerB);
			}
			if (
				DATA[questionCount].answerC !==
				DATA[questionCount].answerCorrect
			) {
				arrIncorrect.push(DATA[questionCount].answerC);
			}
			if (
				DATA[questionCount].answerD !==
				DATA[questionCount].answerCorrect
			) {
			...
			for (let i = 0; i < newArrIncorrect.current.length; i++) {
				if (
					DATA[questionCount].answerA === newArrIncorrect.current[i]
				) {
				...
				if (
					DATA[questionCount].answerB === newArrIncorrect.current[i]
				) {
				...
				if (
					DATA[questionCount].answerC === newArrIncorrect.current[i]
				) {
				...
				if (
					DATA[questionCount].answerD === newArrIncorrect.current[i]
				) {
	...
	const helpAskTheSpectator = () => {
		...
		if (newArrIncorrect.current.length !== 0) {
			...
			for (let i = 0; i < newArrIncorrect.current.length; i++) {
				...
				if (
					...
					percentValidCTemp = Math.round(
						Math.random() *
							(55 - percentValidATemp - percentValidBTemp)
					);
				}
				if (
					newArrIncorrect.current[i] ===
			...
			percentValidC.current = Math.round(
				Math.random() *
					(55 - percentValidA.current - percentValidB.current)
			);
				...
				<div id="process">
					<div id="helps">
						...
						<div className="help" onClick={helpAskTheSpectator}>
							<img
								src={helpAskTheSpectatorImg}
								alt="help-ask-spectator"
							/>
						</div>
					</div>
					<div id="total-question">
						<div
							...
							style={{
								backgroundColor: question15.backgroundColor
							}}
						>
							<div
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question14.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question13.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question12.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question11.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question10.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question9.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question8.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question7.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question6.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question5.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question4.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question3.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question2.backgroundColor
							}}
						>
							<div
								className="question-number"
						...
						<div
							className="question-of-process"
							style={{
								backgroundColor: question1.backgroundColor
							}}
						>
							<div
								className="question-number"
