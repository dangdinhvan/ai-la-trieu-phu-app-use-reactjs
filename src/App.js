...
function App() {
  ...
  const [question1, setQuestion1] = useState({ backgroundColor: '#ffc919', color: '#222' });
  const [question2, setQuestion2] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question3, setQuestion3] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question4, setQuestion4] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question5, setQuestion5] = useState({ backgroundColor: 'transparent', color: 'white' });
  const [question6, setQuestion6] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question7, setQuestion7] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question8, setQuestion8] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question9, setQuestion9] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question10, setQuestion10] = useState({ backgroundColor: 'transparent', color: 'white' });
  const [question11, setQuestion11] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question12, setQuestion12] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question13, setQuestion13] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question14, setQuestion14] = useState({ backgroundColor: 'transparent', color: '#edbc1a' });
  const [question15, setQuestion15] = useState({ backgroundColor: 'transparent', color: 'white' });
  ...
  const confirmBtn = () => {
    ...
    else if (DATA[questionCount].answerB === DATA[questionCount].answerCorrect) {
      answerB.current.style.animation = 'nhap-nhay 0.3s linear infinite';
    }
    else if (DATA[questionCount].answerC === DATA[questionCount].answerCorrect) {
      answerC.current.style.animation = 'nhap-nhay 0.3s linear infinite';
    }
    else if (DATA[questionCount].answerD === DATA[questionCount].answerCorrect) {
  ...
  const help5050 = () => {
    if (help5050State === true) {
      ...
      let incorrectItem = arrIncorrect[Math.floor(Math.random() * arrIncorrect.length)];
      let newArrIncorrect = [];
      for (let i = 0; i < arrIncorrect.length; i++) {
        if (arrIncorrect[i] !== incorrectItem) {
          newArrIncorrect.push(arrIncorrect[i]);
        }
      }

      for (let i = 0; i < newArrIncorrect.length; i++) {
        if (DATA[questionCount].answerA === newArrIncorrect[i]) {
          answerA.current.style.color = "#2359b6";
          answerA.current.style.background = "#2359b6";
          setAnswerAState(true);
        }
        if (DATA[questionCount].answerB === newArrIncorrect[i]) {
          answerB.current.style.color = "#2359b6";
          answerB.current.style.background = "#2359b6";
          setAnswerBState(true);
        }
        if (DATA[questionCount].answerC === newArrIncorrect[i]) {
          answerC.current.style.color = "#2359b6";
          answerC.current.style.background = "#2359b6";
          setAnswerCState(true);
        }
        if (DATA[questionCount].answerD === newArrIncorrect[i]) {
      ...
      <div id="question-answers">
        ...
        <div id="answers">
          <div className="line">
            ...
            <button id="A" onClick={() => choice('a')} ref={answerA} className="content-answer" disabled={answerAState}>
              {DATA[i].answerA}
            </button>
            <div className="space">
              <div className="tren" />
            ...
            <button id="B" onClick={() => choice('b')} ref={answerB} className="content-answer" disabled={answerBState}>
              {DATA[i].answerB}
            </button>
            <div className="space">
              <div className="tren" />
          ...
          <div className="line">
            ...
            <button id="C" onClick={() => choice('c')} ref={answerC} className="content-answer" disabled={answerCState}>
              {DATA[i].answerC}
            </button>
            <div className="space">
              <div className="tren" />
            ...
            <button id="D" onClick={() => choice('d')} ref={answerD} className="content-answer" disabled={answerDState}>
              {DATA[i].answerD}
            </button>
            <div className="space">
              <div className="tren" />
        ...
        <div id="select">
          ...
          <button className="button" onClick={confirmBtn} disabled={confirmBtnState}>
            Xác nhận câu trả lời
          </button>
          <button className="button" onClick={nextBtn} disabled={nextBtnState}>
            {nextBtnHtml}
          </button>
        </div>
      </div>
      <div id="process">
        ...
        <div id="total-question">
          <div className="question-of-process" style={{ backgroundColor: question15.backgroundColor }}>
            <div className="question-number" style={{ color: question15.color }}>15</div>
            <div id="bounty" style={{ color: question15.color }}>150.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question14.backgroundColor }}>
            <div className="question-number" style={{ color: question14.color }}>14</div>
            <div id="bounty" style={{ color: question14.color }}>85.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question13.backgroundColor }}>
            <div className="question-number" style={{ color: question13.color }}>13</div>
            <div id="bounty" style={{ color: question13.color }}>60.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question12.backgroundColor }}>
            <div className="question-number" style={{ color: question12.color }}>12</div>
            <div id="bounty" style={{ color: question12.color }}>40.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question11.backgroundColor }}>
            <div className="question-number" style={{ color: question11.color }}>11</div>
            <div id="bounty" style={{ color: question11.color }}>30.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question10.backgroundColor }}>
            <div className="question-number" style={{ color: question10.color }}>10</div>
            <div id="bounty" style={{ color: question10.color }}>22.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question9.backgroundColor }}>
            <div className="question-number" style={{ color: question9.color }}>9</div>
            <div id="bounty" style={{ color: question9.color }}>14.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question8.backgroundColor }}>
            <div className="question-number" style={{ color: question8.color }}>8</div>
            <div id="bounty" style={{ color: question8.color }}>10.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question7.backgroundColor }}>
            <div className="question-number" style={{ color: question7.color }}>7</div>
            <div id="bounty" style={{ color: question7.color }}>6.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question6.backgroundColor }} >
            <div className="question-number" style={{ color: question6.color }}>6</div>
            <div id="bounty" style={{ color: question6.color }}>3.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question5.backgroundColor }}>
            <div className="question-number" style={{ color: question5.color }}>5</div>
            <div id="bounty" style={{ color: question5.color }}>2.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question4.backgroundColor }}>
            <div className="question-number" style={{ color: question4.color }}>4</div>
            <div id="bounty" style={{ color: question4.color }}>1.000.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question3.backgroundColor }}>
            <div className="question-number" style={{ color: question3.color }}>3</div>
            <div id="bounty" style={{ color: question3.color }}>600.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question2.backgroundColor }}>
            <div className="question-number" style={{ color: question2.color }}>2</div>
            <div id="bounty" style={{ color: question2.color }}>400.000</div>
          </div>
          <div className="question-of-process" style={{ backgroundColor: question1.backgroundColor }}>
            <div className="question-number" style={{ color: question1.color }}>1</div>
            <div id="bounty" style={{ color: question1.color }}>200.000</div>
          </div>
        </div>
      </div>
    </div >
    ...
    startPage ?
      (
        <div id="start">
          <img src={logo}
            alt="anh logo" />
          <button className="play-again" onClick={intoTheGame}>Start</button>
        </div>
      ) :
      (
        mainPage ?
          ...
          (
            <div id="end-game">
              ...
              <button class="play-again" onClick={exitBtn}>Chơi lại</button>
            </div>
          )
      )
  );
